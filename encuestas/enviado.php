...
<?php
						...
						/* para ver que devuelve el formulario */ echo '<b>Nombre: </b>',$nombre,' ', $apellido,'<br>','<b>Email: </b>', $email,'<br>','<b>La información previa sobre sala, horarios y objetivos fue clara y oportuna: </b>',$pregunta1,'<br>',$pregunta2,'<br>',$pregunta3,'<br>',$pregunta4,'<br>',$pregunta5,'<br>',$pregunta6,'<br>',$pregunta7,'<br>',$pregunta8,'<br>',$pregunta9,'<br>',$pregunta10,'<br>',$pregunta11,'<br>',$pregunta12,'<br>',$pregunta13,'<br>',$pregunta14,'<br>',$pregunta15,'<br>',$pregunta16,'<br>',$pregunta17,'<br>',$pregunta18,'<br>',$pregunta19,'<br>',$pregunta20,'<br>','<b>Nombre del curso: </b>',$id_curso,'<br>','<b>Comentarios u Observaciones: </b>', $comentarios;


						 $sql = ("INSERT INTO `capacitaciones`.`encuesta` (`nombre_alumno`, `apellido_alumno`, `email_alumno`, `id_curso`, `fecha_evaluacion`, `pregunta1`, `pregunta2`, `pregunta3`, `pregunta4`, `pregunta5`, `pregunta6`, `pregunta7`, `pregunta8`, `pregunta9`, `pregunta10`, `pregunta11`, `pregunta12`, `pregunta13`, `pregunta14`, `pregunta15`, `pregunta16`, `pregunta17`, `pregunta18`, `pregunta19`, `pregunta20`, `comentarios`) VALUES ('$nombre', '$apellido', '$email', '$id_curso', NOW(), '$pregunta1', '$pregunta2', '$pregunta3', '$pregunta4', '$pregunta5', '$pregunta6', '$pregunta7', '$pregunta8', '$pregunta9', '$pregunta10', '$pregunta11', '$pregunta12', '$pregunta13', '$pregunta14', '$pregunta15', '$pregunta16', '$pregunta17', '$pregunta18', '$pregunta19', '$pregunta20', '$comentarios')"); 
