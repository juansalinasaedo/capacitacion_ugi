					...
					<div class="col-xs-11 text-right menu-1">
						...
						<!--	<li><a href="pricing.html">Pricing</a></li> -->
							<li class="has-dropdown">
								<a href="blog.html">Ambitos</a>
								<ul class="dropdown">
									<li><a href="#">Jurídica</a></li>
									<li><a href="#">Gestión</a></li>
									<li><a href="#">Liderazgo y desarrollo</a></li>
...
<?php
   function get_client_ip() {
	...
	<embed src="cuestionario_embed.php" width="100%" height="900px"></embed>
...
<!--  <div id="fh5co-contact">
      ...
      <!--	<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						<h3>Contactenos</h3>
						<ul>
							<li class="address">Unidad de gestión e Informática, <br> Fiscalía Regional del Maule</li>
		...
		<!--		<div class="col-md-6 animate-box">
            ...
            <div class="row form-group">
              <div class="col-md-12">
               ...
               <!-- <input type="text" name="nombre_curso" id="nombre_curso" class="form-control" placeholder="Nombre del curso - seminario - taller">
              </div>
            </div> -->
    ...
    <!--   <input type="hidden" id="dir" name="ip" value="<?php echo $ip_usuario; ?>"> --> <!-- Podría ser <?=$ip?>, como fomra abreviada -->
			...
			<!--			<div class="row form-group">
							<div class="col-md-12">
								<label for="email">Email</label> -->
							<!--	<input type="text" name="email" id="email" class="form-control" placeholder="Su dirección Email">
							</div>
						</div> -->
