							...
							<div id="middle-wizard">
								...
								<!-- fin mail del inscrito -->			
										...
										<div class="col-md-6">
											...
											<select name="curso" id="curso" class="form-control" >
								                    ...
								                    <?php
								                        $query = $mysqli -> query ("
								                        	SELECT inscripciones.id_curso, cursos.nombre_curso
															FROM cursos
                             ...
                             <!-- preguntas 1 y 2 -->
								...
								<!-- fin pregunta 16 -->
								 ...
								 <!-- preguntas 17 al 20 -->
								<div class="step">
									<h3 class="main_question"><strong>2/4</strong>Preguntas Finales</h3>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group clearfix">
												<label class="rating_type">Demuestra dominio del tema, argumentando con evidencia y respondiendo preguntas.</label>
												<span class="rating">
												<input type="radio" class="required rating-input" id="rating-input-17-5" name="pregunta17" value="5 Estrellas"><label for="rating-input-17-5" class="rating-star"></label>
												<input type="radio" class="required rating-input" id="rating-input-17-4" name="pregunta17" value="4 Estrellas"><label for="rating-input-17-4" class="rating-star"></label>
												<input type="radio" class="required rating-input" id="rating-input-17-3" name="pregunta17" value="3 Estrellas"><label for="rating-input-17-3" class="rating-star"></label>
												<input type="radio" class="required rating-input" id="rating-input-17-2" name="pregunta17" value="2 Estrellas"><label for="rating-input-17-2" class="rating-star"></label>
												<input type="radio" class="required rating-input" id="rating-input-17-1" name="pregunta17" value="1 Estrellas"><label for="rating-input-17-1" class="rating-star"></label>
												</span>
											</div>
											<div class="form-group clearfix">
